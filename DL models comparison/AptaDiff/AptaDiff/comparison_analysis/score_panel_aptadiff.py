...
EMB_PANEL = 'embed_CS_panel_AptaDiff.csv'           # columns: (panel_id or index), seq, dim*
PANEL_IDS = 'CS_panel.csv'                          # panel_id,sequence,sequence_2d   (used only for IDs)
KDE_PATH  = 'CS_R3_AptaDiff_latentKDE.joblib'
OUT_SCORES = 'scores_CS_panel_aptadiff.csv'
