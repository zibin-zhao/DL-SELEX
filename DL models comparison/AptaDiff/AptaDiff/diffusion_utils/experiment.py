...
def add_exp_args(parser, epochs, eval_every, check_every, log_wandb):
    ...
    parser.add_argument('--check_every', type=int, default=check_every)
    parser.add_argument('--log_tb', type=eval, default=True)
    parser.add_argument('--log_wandb', type=eval, default=log_wandb)
