...
def provide_ax(func):
    from vae.raptgen.visualization import get_ax
    ...
    def __init__(self, isRNA=True):
        ...
        for text, color in zip(self.string, [green, red, yellow, blue]):
            ...
            font = ImageFont.truetype(
                "/Users/da/PycharmProjects/raptgen/fonts/opentype/noto/NotoSansCJK-Bold.ttc", size=800)
...
def draw_most_probable(a, e_m, ax, fig=None, header="phmm", save=True, force=False, drawer=None, draw_only_insertion=True):
    ...
    from vae.raptgen.data import State, Transition
    from vae.raptgen.data import ProfileHMMSampler
    if drawer is None:
